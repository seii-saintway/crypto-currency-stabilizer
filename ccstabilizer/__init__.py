...
__all__ = ['Exchange', 'Binance', 'BinanceAPI', 'MXC', 'MXCAPI', 'Status', 'Fetcher', 'Portfolio', 'BookKeeper',
           'Trader', 'Notifier']
...
#         max_used_fiat_money = self.unused_fiat_money + self.total_gained_fiat_money
    ...
    def get_usage(self, new_unused_fiat_money=None):
        return self.used_fiat_money / self.get_max_used_fiat_money(new_unused_fiat_money)
    ...
    def estimate_status(cls, status, old_portfolio, new_portfolio):
        ...
        if old_amount > new_amount and old_fiat_money < new_fiat_money:
            ...
            if now_sell_fiat_price is None:
                cls.fth.write(new_status.last_transaction)
