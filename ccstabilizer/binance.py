...
GAINABLE_UNIT_CC_SOLD_RATIO = {
    ...
    ('LINK', 'USDT'): Decimal('0.146'),
    ('NMR', 'USDT'): Decimal('0.146'),
#     ('NPXS', 'USDT'): Decimal('0.146'),
